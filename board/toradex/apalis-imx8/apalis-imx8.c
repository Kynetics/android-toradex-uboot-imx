...
static void select_dt_from_module_version(void)
{
	switch(get_pcb_revision()) {
		case PCB_VERSION_1_0:
			...
			env_set("board_device_tree", FDT_FILE_V1_0);
...
#endif
			break;
		case PCB_VERSION_1_1:
			env_set("fdtfile", FDT_FILE_V1_1);
			env_set("board_device_tree", FDT_FILE_V1_1);
			printf("Detected a V1.1 module, setting " \
				"correct devicetree\n");
#ifndef CONFIG_ENV_IS_NOWHERE
			env_save();
#endif
